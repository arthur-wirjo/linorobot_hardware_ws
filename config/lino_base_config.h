...
#define COUNTS_PER_REV1 495                 // wheel1 encoder's no of ticks per rev
#define COUNTS_PER_REV2 500                 // wheel2 encoder's no of ticks per rev
#define COUNTS_PER_REV3 510                 // wheel3 encoder's no of ticks per rev
#define COUNTS_PER_REV4 510                 // wheel4 encoder's no of ticks per rev
